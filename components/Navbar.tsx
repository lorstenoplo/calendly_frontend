    ...
    <header className="text-gray-600 body-font border border-b-2 mb-2">
      <div className="container mx-auto flex flex-wrap p-4 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <span className="ml-3 text-xl">CalendKey</span>
        </a>
        ...
        <button
          className="ml-2 inline-flex items-center text-white bg-red-400 border-0 py-1 px-3 focus:outline-none hover:bg-red-500 rounded text-base mt-4 md:mt-0"
          onClick={() => {
